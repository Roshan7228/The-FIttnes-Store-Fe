...
const [subtotal, setSubtotal] = useState(calculateSubtotal());
  ...
  const links = {
    Banches: `https://the-fitness-store-be.onrender.com/Banches/${param.id}`,
    Product2: `https://the-fitness-store-be.onrender.com/Product2/${param.id}`,
    Cardio: `https://the-fitness-store-be.onrender.com/Cardio/${param.id}`,
    GymSystem: `https://the-fitness-store-be.onrender.com/GYMSYSTEM/${param.id}`
  };
